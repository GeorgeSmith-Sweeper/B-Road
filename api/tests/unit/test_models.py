...
class TestSavedRoute:
    ...
    def test_saved_route_cascade_delete_from_session(self, test_db_session, sample_session, sample_route):
        ...
        deleted_route = test_db_session.query(SavedRoute).filter_by(route_id=route_id).first()
...
class TestRouteSegment:
    ...
    def test_route_segment_position_unique_per_route(self, test_db_session, sample_route):
    ...
    def test_route_segment_cascade_delete_from_route(self, test_db_session, sample_route, sample_segments):
        ...
        for seg_id in segment_ids:
            deleted_segment = test_db_session.query(RouteSegment).filter_by(id=seg_id).first()
